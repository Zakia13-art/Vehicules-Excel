<?php
/**
 * AUTO SPLIT - 30 DERNIERS JOURS
 * Templates: 529 (KM), 36793 (Infra), 21146 (Eval)
 */
...
function logAuto($message, $type = 'INFO') {
    ...
    $file = __DIR__ . "/logs/auto_split_30j.log";
...
logAuto("========================================");
logAuto("AUTO SPLIT - 30 DERNIERS JOURS");
...
for ($day = 0; $day <= 30; $day++) {
    ...
    // Afficher progression chaque jour
    if ($day % 5 == 0) {
        logAuto("Progression: Jour $day/30 - KM: $total_km, Infra: $total_infra, Eval: $total_eval");
    }
}

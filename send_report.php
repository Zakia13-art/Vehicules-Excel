...
function buildHtmlFlotte(array $rows, string $date, string $css): string {
    ...
    <table class="data"><thead><tr>
        <th>Véhicule</th><th>Note /100 (A)</th><th>Alertes (B)</th><th>Alertes /100km (C)</th>
        <th>Heures (D)</th><th>Km (E)</th><th>Charge (F)</th><th>Risque (G)</th>
...
function buildHtmlSynthese(array $s, string $date, string $css): string {
    ...
    <table class="data"><thead>
        <tr>
            <th>Entreprise</th><th style="text-align:center;">Nb véhicules</th><th style="text-align:center;">Total Note /100</th>
            <th style="text-align:center;">Total Alertes CRIT</th><th style="text-align:center;">Total Kilométrage</th><th style="text-align:center;">Moy. Infr. /100km</th>
            <th colspan="3" style="text-align:center;">Total Infractions Sign</th>
        </tr>
        <tr>
            <th colspan="6"></th>
            <th style="color:#ef4444;">Rouge</th>

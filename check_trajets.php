...
try {
	...
	// Count new trajets (last 5 minutes)
...
<head>
	...
	<style>
		*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
		...
		.pagination-info { display: flex; justify-content: center; align-items: center; gap: 12px; padding: 20px 16px; color: #64748b; font-size: 0.85rem; }
		.pagination-btn { 
			background: #06b6d4; 
			color: #fff; 
			border: none; 
		...
		.pagination-btn:hover { background: #0891b2; }
...
<div class="page-header">
	<h1>📊 Rapports Wialon</h1>
	<div class="nav-buttons">
		<a href="lesgets.php" class="nav-btn">⬇️ Import 7 jours</a>
		<a href="rapp.php" class="nav-btn">📡 Import Historique</a>
	</div>
</div>
	...
	<div class="pagination-info">
		...
		<?php if ($currentPage > 1): ?>
			<form method="POST" style="display: inline;">
				...
				<button type="submit" class="pagination-btn">← Précédente</button>
			</form>
		<?php endif; ?>
		...
		<?php if ($currentPage < $totalPages): ?>
			<form method="POST" style="display: inline;">
				...
				<input type="hidden" name="items_per_page" value="<?= $itemsPerPage ?>">
				<input type="hidden" name="page" value="<?= $currentPage + 1 ?>">
				<button type="submit" class="pagination-btn">Suivante →</button>
			</form>
		<?php endif; ?>
	</div>
	<?php endif; ?>

...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-send:hover, .btn-tableau:hover { background: #1e293b; }
        .btn-send span, .btn-tableau span { font-size: 1rem; }
...
<div class="page-header">
    ...
    <div class="header-actions">
        <p>Totaux calculés depuis les fichiers Excel — Généré le <?= date('d/m/Y') ?> à <?= date('H:i') ?></p>
        <div class="buttons-group">
            <button class="btn-send" onclick="sendReport()">
                <span>📧</span> Envoyer le rapport
            </button>
            <a href="tableau.php" class="btn-tableau">
                <span>🚗</span> Voir détail flotte
            </a>
        </div>
    </div>
</div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2">Total Alertes CRIT </th>
                <th rowspan="2">Total Kilométrage</th>
                <th rowspan="2">Moy. Alertes. /100km</th>
                <th colspan="3">Total Alertes Sign</th>
            </tr>
            <tr>
